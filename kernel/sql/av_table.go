...
func RenderAttributeViewTable(attrView *av.AttributeView, view *av.View, query string, depth *int, cachedAttrViews map[string]*av.AttributeView) (ret *av.Table) {
	return RenderAttributeViewTableWithDataDir(util.DataDir, attrView, view, query, depth, cachedAttrViews)
}

func RenderAttributeViewTableWithDataDir(dataDir string, attrView *av.AttributeView, view *av.View, query string, depth *int, cachedAttrViews map[string]*av.AttributeView) (ret *av.Table) {
	...
	ials := BatchGetBlockAttrsWithDataDir(dataDir, ialIDs)
